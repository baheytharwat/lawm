import einops
import lawm.utils.pytorch3d_transforms as pt
import torch
...
from lawm.algos.utils.diffuser_actor_utils.layers import (
    FFWRelativeCrossAttentionModule,
    FFWRelativeSelfAttentionModule,
    FFWRelativeSelfCrossAttentionModule,
    ParallelAttention,
)
from lawm.algos.utils.diffuser_actor_utils.position_encodings import (
